...
namespace AbpBlazorMyTheme.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpBlazorMyThemeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpBlazorMyThemeEfCoreEntityExtensionMappings to extend the IdentityUser entity
